...
module.exports = function(app){
    ...
    var vendorSchema = new Schema(fields);

    vendorSchema.virtual('uri').get(function(){
        
            
                return '/vendors/' + (this.namespace || this._id);
            ...
            vendorSchema.virtual('desc').get(function(){
            ...
            vendorSchema.virtual('original_img_s3').get(function(){
            ...
            vendorSchema.virtual('thumb_img_s3').get(function(){
                var path = require('path');
        ...
        vendorSchema.virtual('archive').get(function(){
    ...
    if (!vendorSchema.options.toObject) vendorSchema.options.toObject = {};
    vendorSchema.options.toObject.transform = function (doc, ret, options) {
        ret.uri = doc.uri;
