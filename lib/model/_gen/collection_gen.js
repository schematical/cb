...
module.exports = function(app){
    ...
    collectionSchema.virtual('uri').get(function(){
        
            
                if(!this.account){
                    var parent_id = null;
                }else{
                    var parent_id =  (this.account.uri || ('/' + this.account));
                }
                return '' + parent_id   + '/collection/' + (this.namespace || this._id);
            ...
            collectionSchema.virtual('desc').get(function(){
            ...
            collectionSchema.virtual('original_img_s3').get(function(){
            ...
            collectionSchema.virtual('thumb_img_s3').get(function(){
                var path = require('path');
        ...
        collectionSchema.virtual('archive').get(function(){
